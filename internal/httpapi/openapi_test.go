...
var platformOpenAPIRoutes = []struct {
	...
	{"post", "/api/v1/system/ownership/challenge", "systemOwnershipChallenge"},
	{"post", "/api/v1/system/ownership/verify", "systemOwnershipVerify"},
	{"post", "/api/v1/dev/onboard/claim", "devOnboardClaim"},
